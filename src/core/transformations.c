...
void transform_flip(image_t *image,
                    void (*flip_function)())
{
...
void transform_flip_h_core(image_t *i,
                           byte old[i->height][i->width][i->depth],
                           byte new[i->height][i->width][i->depth])
{
...
void transform_flip_v_core(image_t *i,
                           byte old[i->height][i->width][i->depth],
                           byte new[i->height][i->width][i->depth])
{
